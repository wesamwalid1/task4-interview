      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            reusableTextField(schoolViewModel.school?.name ?? schoolName, Icons.school),
            const SizedBox(height: 15,),
            reusableTextField( schoolViewModel.school?.address ?? schoolAddress, Icons.location_on_rounded),
            const SizedBox(height: 15,),
            reusableTextField(schoolViewModel.school?.numberOfStudents ?? studentsNo, Icons.person),
            const SizedBox(height: 15,),
            reusableTextField( schoolViewModel.school?.numberOfTeachers ?? teachersNo, Icons.person),
            Padding(
              ...
              child: Container(
                  ...
                  child: Padding(
                    ...
                    child: ButtonTheme(
                      ...
                      child: TextButton(
                        onPressed: () {
                          schoolViewModel.loadSchoolData();
                        },
                        child: const Text(
                          'Show Data',
                          style: TextStyle(
